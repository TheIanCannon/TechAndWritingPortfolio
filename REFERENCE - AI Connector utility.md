...
| ----------- | ----------- |
| ![AI Connector utility with no skill selected. The utility functions only after you select a custom skill that includes a query.](https://github.com/TheIanCannon/TechAndWritingPortfolio/blob/main/portfolio%20images/AIConnector01.png)[_[AI Connector utility with no skill selected. The utility functions only after you select a custom skill that includes a query.]_] | ![AI Connector utility with Web Search skill selected. All input and output mappings derive from the custom skill.](https://github.com/TheIanCannon/TechAndWritingPortfolio/blob/main/portfolio%20images/AIConnector02.png)[_AI Connector utility with Web Search skill selected. All input and output mappings derive from the custom skill._] |
